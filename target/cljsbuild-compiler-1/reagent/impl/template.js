...
var G__12305 = o;
(G__12305[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__12307__i < G__12307__a.length) {G__12307__a[G__12307__i] = arguments[G__12307__i + 0]; ++G__12307__i;}
  args = new cljs.core.IndexedSeq(G__12307__a,0);
} 
...
if(cljs.core.truth_((function (){var and__6130__auto__ = cljs.core.some_QMARK_(reagent.impl.template.find_dom_node);
if(and__6130__auto__){
var and__6130__auto____$1 = cljs.core.some_QMARK_(jsprops);
...
return reagent.impl.template.input_handle_change(this$,on_change,p1__12311_SHARP_);
...
var vec__12318 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12318,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12318,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12318,(2),null);
...
var jsprops = {"argv": v};
var temp__4429__auto___12321 = reagent.impl.template.key_from_vec(v);
if((temp__4429__auto___12321 == null)){
} else {
var key_12322 = temp__4429__auto___12321;
...
var G__12324 = (new reagent.impl.template.NativeWrapper());
(G__12324["name"] = c);
...
var G__12326 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__12326) : reagent.impl.template.as_element.call(null,G__12326));
} else {
...
var len__7200__auto___12332 = arguments.length;
var i__7201__auto___12333 = (0);
while(true){
if((i__7201__auto___12333 < len__7200__auto___12332)){
args__7207__auto__.push((arguments[i__7201__auto___12333]));

var G__12334 = (i__7201__auto___12333 + (1));
i__7201__auto___12333 = G__12334;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq12330){
var G__12331 = cljs.core.first(seq12330);
var seq12330__$1 = cljs.core.next(seq12330);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__12331,seq12330__$1);
});
...
break;
default:
var G__12338 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__12338;
continue;
...
var n__7045__auto___12339 = a.length;
var i_12340 = (0);
while(true){
if((i_12340 < n__7045__auto___12339)){
(a[i_12340] = reagent.impl.template.as_element((a[i_12340])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__7045__auto___12342 = a.length;
var i_12343 = (0);
while(true){
if((i_12343 < n__7045__auto___12342)){
var val_12344 = (a[i_12343]);
if((cljs.core.vector_QMARK_(val_12344)) && ((reagent.impl.template.key_from_vec(val_12344) == null))){
(o["no-key"] = true);
} else {
}

(a[i_12343] = reagent.impl.template.as_element(val_12344));
...
var ctx = {};
var vec__12347 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12347,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12347,(1),null);
...
var G__12349 = (cljs.core.count(argv) - first_child);
switch (G__12349) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__12349){
