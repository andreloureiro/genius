...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__37779__auto__,writer__37780__auto__,opt__37781__auto__){
return cljs.core._write.call(null,writer__37780__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__43670 = o;
(G__43670[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__43672__i < G__43672__a.length) {G__43672__a[G__43672__i] = arguments[G__43672__i + 0]; ++G__43672__i;}
  args = new cljs.core.IndexedSeq(G__43672__a,0);
} 
...
if(cljs.core.truth_((function (){var and__37169__auto__ = cljs.core.some_QMARK_.call(null,reagent.impl.template.find_dom_node);
if(and__37169__auto__){
var and__37169__auto____$1 = cljs.core.some_QMARK_.call(null,jsprops);
if(and__37169__auto____$1){
var and__37169__auto____$2 = (jsprops["hasOwnProperty"])("onChange");
if(cljs.core.truth_(and__37169__auto____$2)){
...
var G__43678 = jsprops;
(G__43678["defaultValue"] = value);

(G__43678["onChange"] = ((function (G__43678,v,value,on_change){
return (function (p1__43676_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__43676_SHARP_);
});})(G__43678,v,value,on_change))
);
...
var vec__43683 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__43683,(0),null);
var id = cljs.core.nth.call(null,vec__43683,(1),null);
var class$ = cljs.core.nth.call(null,vec__43683,(2),null);
...
var jsprops = {"argv": v};
var temp__4429__auto___43686 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4429__auto___43686 == null)){
} else {
var key_43687 = temp__4429__auto___43686;
(jsprops["key"] = key_43687);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__43689 = (new reagent.impl.template.NativeWrapper());
(G__43689["name"] = c);
...
var len__38239__auto___43695 = arguments.length;
var i__38240__auto___43696 = (0);
while(true){
if((i__38240__auto___43696 < len__38239__auto___43695)){
args__38246__auto__.push((arguments[i__38240__auto___43696]));

var G__43697 = (i__38240__auto___43696 + (1));
i__38240__auto___43696 = G__43697;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__38247__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq43693){
var G__43694 = cljs.core.first.call(null,seq43693);
var seq43693__$1 = cljs.core.next.call(null,seq43693);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__43694,seq43693__$1);
});
...
break;
default:
var G__43701 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__43701;
continue;
...
var n__38084__auto___43702 = a.length;
var i_43703 = (0);
while(true){
if((i_43703 < n__38084__auto___43702)){
(a[i_43703] = reagent.impl.template.as_element.call(null,(a[i_43703])));

var G__43704 = (i_43703 + (1));
i_43703 = G__43704;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__38084__auto___43705 = a.length;
var i_43706 = (0);
while(true){
if((i_43706 < n__38084__auto___43705)){
var val_43707 = (a[i_43706]);
if((cljs.core.vector_QMARK_.call(null,val_43707)) && ((reagent.impl.template.key_from_vec.call(null,val_43707) == null))){
(o["no-key"] = true);
} else {
}

(a[i_43706] = reagent.impl.template.as_element.call(null,val_43707));

var G__43708 = (i_43706 + (1));
i_43706 = G__43708;
continue;
} else {
}
...
var ctx = {};
var vec__43710 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__43710,(0),null);
var derefed = cljs.core.nth.call(null,vec__43710,(1),null);
...
var G__43712 = (cljs.core.count.call(null,argv) - first_child);
switch (G__43712) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__43712){
...
//# sourceMappingURL=template.js.map?rel=1459924596460